...
mkDerivation {
  ...
  postUnpack = "sourceRoot+=/yuntan-common-result; echo source root reset to $sourceRoot";
  libraryHaskellDepends = [ aeson base text yuntan-common-json ];
